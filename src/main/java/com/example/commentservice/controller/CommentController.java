...
public class CommentController {
    ...
    public ResponseEntity<Comment> updateComment(@RequestBody @Valid Comment commentModel, @PathVariable("postId") String postId, @PathVariable("commentId") String commentId){
